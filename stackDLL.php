...
class DoublyLinkedList {
	...
	function insertAtHead($data) { // push method
	...
	function deleteAtTail() { // pop method
		if($this->head != NULL) {
...
class DoublyLinkedListDemo {
	function main($args) {
		...
		$intergers->insertAtHead(5); // push method
		...
		$intergers->deleteAtTail(); // pop method
		
		print_r($intergers); 
		
		$intergers->deleteAtTail(); // pop method
		
		$peek = $intergers->getHead(); // peek method
